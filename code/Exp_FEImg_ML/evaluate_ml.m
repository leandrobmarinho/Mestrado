function [ ] = evaluate_ml( dataset, params )
...
if(find(ismember(params.mlMethods,'bayes')))
    ...
    result = simBayes(dataset, config);
...
if(find(ismember(params.mlMethods,'svmLinear')))
    ...
    result = simMultiSVM( dataset, optParam );
