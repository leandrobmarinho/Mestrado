function [ results ] = gausMixSim(dados, ptrn, numRepet, conf)
...
for i = 1 : numRepet,
    ...
    tic
    [modelo{i}] = trainGausMix(trainData, conf);
    tempoTrein(i) = toc;
    
    %% Avaliando o conjunto de treinamento
    [Yh] = testeGausMix(modelo{i}, trainData);
    ...
    %% Testando o Bayes
    tic
    [Yh] = testeGausMix(modelo{i}, testData);
    tempoTeste(i) = toc;
