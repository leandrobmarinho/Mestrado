...
load('../dados/haralick_hu_lbp_mide - Gray_H_sim.mat');
...
% save(sprintf('SVM - %s - Haralick - Gray_H_sim', config.fkernel), 'result', 'config')
...
% save(sprintf('SVM - %s - Hu - Gray_H_sim', config.fkernel), 'result', 'config')
...
% save(sprintf('SVM - %s - LBP - Gray_H_sim', config.fkernel), 'result', 'config')
...
% save(sprintf('SVM - %s - Mide - Gray_H_sim', config.fkernel), 'result', 'config')
...
% optParam = searchParamSVM(dataHaralick, params, numRep, ptrn );
% result = simMultiSVM( dataHaralick, ptrn, numRep, optParam );
% save(sprintf('LSSVM - %s - Haralick - Gray_H_sim', config.fkernel), 'result', 'config')
% fprintf('LSSVM - %s - Haralick', config.fkernel)
% 
% optParam = searchParamSVM(dataHu, params, numRep, ptrn );
% result = simMultiSVM( dataHu, ptrn, numRep, optParam );
% save(sprintf('LSSVM - %s - Hu - Gray_H_sim', config.fkernel), 'result', 'config')
% fprintf('LSSVM - %s - Hu', config.fkernel)
% 
% optParam = searchParamSVM(dataLBP, params, numRep, ptrn );
% result = simMultiSVM( dataLBP, ptrn, numRep, optParam );
% save(sprintf('LSSVM - %s - LBP - Gray_H_sim', config.fkernel), 'result', 'config')
% fprintf('LSSVM - %s - LBP', config.fkernel)
% 
% optParam = searchParamSVM(dataMide, params, numRep, ptrn );
% result = simMultiSVM( dataMide, ptrn, numRep, optParam );
% save(sprintf('LSSVM - %s - Mide - Gray_H_sim', config.fkernel), 'result', 'config')
...
%     save(sprintf('haralick mlm_D-%s_%.0f - Gray_H_sim', config.distance, config.k*100),...
%         'result', 'config')
%     fprintf(sprintf('haralick mlm_D-%s_%.0f', config.distance, config.k*100))
% 
% 
%     result = simMLM(dataHu, ptrn, numRep, config);
%     save(sprintf('hu mlm_D-%s_%.0f - Gray_H_sim', config.distance, config.k*100),...
%         'result', 'config')
...
%     save(sprintf('lbp mlm_D-%s_%.0f - Gray_H_sim', config.distance, config.k*100),...
%         'result', 'config')
%     fprintf(sprintf('lbp mlm_D-%s_%.0f', config.distance, config.k*100))
% 
% 
%     result = simMLM(dataMide, ptrn, numRep, config);
%     save(sprintf('mide mlm_D-%s_%.0f - Gray_H_sim', config.distance, config.k*100),...
%         'result', 'config')
...
% 
%     result = simMLM(dataHaralick, ptrn, numRep, config);
%     save(sprintf('haralick - mlm_%s_%d_D-%s_%.0f - Gray_H_sim', config.method, config.NN,...
...
% 
%     result = simMLM(dataHu, ptrn, numRep, config);
%     save(sprintf('hu - mlm_%s_%d_D-%s_%.0f - Gray_H_sim', config.method, config.NN,...
%         config.distance, config.k*100), 'result', 'config')
...
% 
%     result = simMLM(dataLBP, ptrn, numRep, config);
%     save(sprintf('lbp - mlm_%s_%d_D-%s_%.0f - Gray_H_sim', config.method, config.NN,...
%         config.distance, config.k*100), 'result', 'config')
...
% 
%     result = simMLM(dataMide, ptrn, numRep, config);
%     save(sprintf('mide - mlm_%s_%d_D-%s_%.0f - Gray_H_sim', config.method, config.NN,...
%         config.distance, config.k*100), 'result', 'config')
