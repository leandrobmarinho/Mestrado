...
load('../dados/haralick_hu_lbp - Gray.mat');
...
% save(sprintf('4 - LSSVM - %s - Haralick - Gray', config.fkernel), 'result', 'config')
...
% save(sprintf('5 - LSSVM - %s - Hu - Gray', config.fkernel), 'result', 'config')
...
% save(sprintf('6 - LSSVM - %s - LBP - Gray', config.fkernel), 'result', 'config')
...
% optParam = searchParamSVM(dataHaralick, params, numRep, ptrn );
% result = simMultiSVM( dataHaralick, ptrn, numRep, optParam );
% save(sprintf('7 - LSSVM - %s - Haralick - Gray', config.fkernel), 'result', 'config')
% fprintf('7 - LSSVM - %s - Haralick', config.fkernel)
% 
% optParam = searchParamSVM(dataHu, params, numRep, ptrn );
% result = simMultiSVM( dataHu, ptrn, numRep, optParam );
% save(sprintf('8 - LSSVM - %s - Hu - Gray', config.fkernel), 'result', 'config')
% fprintf('8 - LSSVM - %s - Hu', config.fkernel)
% 
% optParam = searchParamSVM(dataLBP, params, numRep, ptrn );
% result = simMultiSVM( dataLBP, ptrn, numRep, optParam );
% save(sprintf('9 - LSSVM - %s - LBP - Gray', config.fkernel), 'result', 'config')
...
%     save(sprintf('%d - mlm_D-%s_%.0f - Gray', i, config.distance, config.k*100),...
%         'result', 'config')
%     fprintf(sprintf('%d - mlm_D-%s_%.0f', i, config.distance, config.k*100))
% 
% 
%     result = simMLM(dataHu, ptrn, numRep, config);
%     save(sprintf('%d - mlm_D-%s_%.0f - Gray', i+1, config.distance, config.k*100),...
%         'result', 'config')
...
%     save(sprintf('%d - mlm_D-%s_%.0f - Gray', i+2, config.distance, config.k*100),...
%         'result', 'config')
...
% 
%     result = simMLM(dataHaralick, ptrn, numRep, config);
%     save(sprintf('%d - mlm_%s_%d_D-%s_%.0f - Gray', i, config.method, config.NN,...
...
% 
%     result = simMLM(dataHu, ptrn, numRep, config);
%     save(sprintf('%d - mlm_%s_%d_D-%s_%.0f - Gray', i+1, config.method, config.NN,...
%         config.distance, config.k*100), 'result', 'config')
%     fprintf(sprintf('%d - mlm_%s_%d_D-%s_%.0f\n', i, config.method, config.NN,...
%         config.distance, config.k*100))
% 
% 
%     result = simMLM(dataLBP, ptrn, numRep, config);
%     save(sprintf('%d - mlm_%s_%d_D-%s_%.0f - Gray', i+2, config.method, config.NN,...
%         config.distance, config.k*100), 'result', 'config')
%     fprintf(sprintf('%d - mlm_%s_%d_D-%s_%.0f\n', i, config.method, config.NN,...
%         config.distance, config.k*100))
% 
...
optParam = searchParamSVM(dataHaralick, params, numRep, ptrn );
result = simMultiSVM( dataHaralick, ptrn, numRep, optParam );
save(sprintf('31 - SVM - %s - Haralick - Gray', config.fkernel), 'result', 'config')
fprintf('31 - SVM - %s - Haralick', config.fkernel)

optParam = searchParamSVM(dataHu, params, numRep, ptrn );
result = simMultiSVM( dataHu, ptrn, numRep, optParam );
save(sprintf('32 - SVM - %s - Hu - Gray', config.fkernel), 'result', 'config')
fprintf('32 - SVM - %s - Hu', config.fkernel)

optParam = searchParamSVM(dataLBP, params, numRep, ptrn );
result = simMultiSVM( dataLBP, ptrn, numRep, optParam );
save(sprintf('33 - SVM - %s - LBP - Gray', config.fkernel), 'result', 'config')
...
optParam = searchParamSVM(dataHaralick, params, numRep, ptrn );
result = simMultiSVM( dataHaralick, ptrn, numRep, optParam );
save(sprintf('34 - SVM - %s - Haralick - Gray', config.fkernel), 'result', 'config')
fprintf('34 - SVM - %s - Haralick', config.fkernel)

optParam = searchParamSVM(dataHu, params, numRep, ptrn );
result = simMultiSVM( dataHu, ptrn, numRep, optParam );
save(sprintf('35 - SVM - %s - Hu - Gray', config.fkernel), 'result', 'config')
fprintf('35 - SVM - %s - Hu', config.fkernel)

optParam = searchParamSVM(dataLBP, params, numRep, ptrn );
result = simMultiSVM( dataLBP, ptrn, numRep, optParam );
save(sprintf('36 - SVM - %s - LBP - Gray', config.fkernel), 'result', 'config')
